...
class EmbeddingProviderFactory:
    ...
    @classmethod
    def create_provider(cls, provider_name: str, config: Dict[str, Any]) -> BaseEmbeddingProvider:
    ...
    @classmethod
    def from_embedding_config(cls, embedding_config) -> BaseEmbeddingProvider:
    ...
    @classmethod
    def _build_provider_config(cls, provider_name: str, embedding_config) -> Dict[str, Any]:
        ...
        if provider_name == 'openai':
            ...
            base_config.update({
                ...
                'deployment_mapping': embedding_config.azure_openai_deployment_mapping,
    ...
    @classmethod
    def register_provider(cls, name: str, provider_class: Type[BaseEmbeddingProvider]) -> None:
    ...
    def get_provider_info(cls) -> Dict[str, Dict[str, Any]]:
        ...
        for name, provider_class in cls._providers.items():
            try:
                ...
                temp_config = {'default_model': 'test'}
...
# Convenience function for creating from EmbeddingConfig
def create_provider_from_config(embedding_config) -> BaseEmbeddingProvider:
    """Create provider from EmbeddingConfig object.
