...
class InstanceCoordinator:
    ...
    def _check_conflicts(self, registry: Dict[str, Any], new_instance: InstanceInfo) -> List[str]:
        ...
        for instance_id, instance_data in registry.items():
            ...
            if (existing.vector_db_path and new_instance.vector_db_path and 
                existing.vector_db_path == new_instance.vector_db_path):
...
class SharedRateLimiter:
    ...
    def get_instance_rate_limit(self) -> int:
        ...
        logger.debug(f"Rate limit for instance {self.coordinator.instance_id}: "
