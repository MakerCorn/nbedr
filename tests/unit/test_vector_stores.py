...
class TestVectorStoresModule:
    ...
    def test_vector_stores_init_import(self):
        ...
        try:
            import nbedr.core.vector_stores

            assert hasattr(nbedr.core.vector_stores, "__name__")
            ...
            if "azure.search" in str(e) or "elasticsearch" in str(e) or "psycopg" in str(e):
                ...
                pytest.fail(f"Failed to import nbedr.core.vector_stores: {e}")

    def test_base_import(self):
        """Test that base module can be imported."""
        try:
            from nbedr.core.vector_stores.base import BaseVectorStore
    ...
    def test_faiss_store_import(self):
        ...
        try:
            from nbedr.core.vector_stores.faiss_store import FAISSVectorStore
    ...
    def test_azure_search_store_import(self):
        ...
        try:
            from nbedr.core.vector_stores.azure_search_store import AzureAISearchVectorStore
    ...
    def test_pgvector_store_import(self):
        ...
        try:
            from nbedr.core.vector_stores.pgvector_store import PGVectorStore
